...
class HeaterAccessory extends BaseAccessory {
  constructor(platform, homebridgeAccessory, deviceConfig) {
    ...
    const infoService = this.Service.AccessoryInformation;

    infoService
    .setCharacteristic(Characteristic.Manufacturer, "Solaire")
    .setCharacteristic(Characteristic.Model, "R4")
    .setCharacteristic(Characteristic.SerialNumber, this.deviceId)
    .setCharacteristic(Characteristic.FirmwareRevision, this.deviceConfig.firmwareVersion || "1.0.0")
    .setCharacteristic(Characteristic.Name, this.deviceConfig.name || this.homebridgeAccessory.displayName);
